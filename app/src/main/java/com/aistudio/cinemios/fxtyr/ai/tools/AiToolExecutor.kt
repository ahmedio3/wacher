package com.aistudio.cinemios.fxtyr.ai.tools

import android.content.Context
import com.aistudio.cinemios.fxtyr.BuildConfig
import com.aistudio.cinemios.fxtyr.ai.AiToolResult
...
import com.aistudio.cinemios.fxtyr.data.remote.RetrofitClient
...
class AiToolExecutor(private val context: Context) {
    ...
    private val repository = com.aistudio.cinemios.fxtyr.data.repository.MovieRepository(database.movieDao)
